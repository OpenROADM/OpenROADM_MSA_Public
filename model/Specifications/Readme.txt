...
__ORrelease 15_0 : Uses Optical specification version 6 / 9 . To be used when the
...
__ORrelease 16_0 : Removed from Specifications directory, as not identified as an
...
-format, TX-OOB-single/multi-channel-value). Service model 16.0.0 also
introduced media-interface-id defined by CMIS for OR transponders.
Includes modification added in Service model 16.1.0 , where
...
__ORrelease 18_0 : Uses Optical specification version 9. To be used when the
